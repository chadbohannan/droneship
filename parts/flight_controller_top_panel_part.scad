...
module flight_controller_top_panel(hole_x, hole_y, post_diameter, bore_diameter, case_floor, fn) {
    difference(){
...
module flight_controller_top_panel_part() {
    ...
    fn = find(params, "fn");
    flight_controller_top_panel(hole_x, hole_y, post_diameter, bore_diameter, case_floor, fn);
}
